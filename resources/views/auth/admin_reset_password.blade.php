                            ...
                            <div class="panel panel-white" id="js-alerts">
                                <div class="panel-body">
                                    <div class="register-box">
                                        ...
                                        <form class="m-t-md" action="{{ route('password.update') }}" method="post">
                                            @csrf
                                            ...
                                            {{-- Confirm Password --}}
                                            <div class="form-group">
                                                <input type="password" name="password_confirmation" class="password form-control" placeholder="Password" required>
                                            </div>
