                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h4 class="panel-title">Education Add</h4>
                        </div>
                        <div class="panel-body ">
                            {{-- Education Store/Post --}}
                            <form action="{{ route('education.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                
                                <div class="form-group">
                                    <label for="university" class="form-control-label">University Name:</label>
                                    <input id="university" class="form-control m-t-xxs" type="text" name="university" placeholder="University Name">
                                </div>
                                <div class="form-group">
                                    <label for="graduation" class="form-control-label">Graduation:</label>
                                    <input id="graduation" class="form-control m-t-xxs" type="text" name="graduation" placeholder="Graduation">
                                </div>
                                <div class="form-group">
