            ...
            <div class="col-md-12">
                <div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <div class="text-left">
                            <h4 class="panel-title">Education Index</h4>
                        </div>
                        <div class="text-right">
                            <a class="btn btn-info" href="{{ route('education.create') }}">Add Education</a>
                        </div>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('education.destroy', $education->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <a class="btn btn-info" href="{{ route('education.edit', $education->id) }}">Edit</a>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
