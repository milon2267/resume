            ...
            <div class="col-md-6">
                <div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title">Banner Delete</h4>
                    </div>
                                    ...
                                    @foreach ($trashes as $key => $data )
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-info" href="{{ route('banner.destroy', $data->id) }}">Edit</a>
                                                <a class="btn btn-danger" href="{{ route('banner.destroy', $data->id) }}">Delete</a>
