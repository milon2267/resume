                    ...
                    <div class="panel panel-white">
                        ...
                        <div class="panel-body">
                            ...
                            <div><iframe class="chartjs-hidden-iframe" tabindex="-1" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; inset: 0px;"></iframe>
                                <canvas id="chart1" height="410" width="747" style="display: block; width: 598px; height: 328px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="panel panel-white">
                        ...
                        <div class="panel-body">
                            ...
                            <div><iframe class="chartjs-hidden-iframe" tabindex="-1" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; inset: 0px;"></iframe>
                                <canvas id="chart2" height="410" width="747" style="display: block; width: 598px; height: 328px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
